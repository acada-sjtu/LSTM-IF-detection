...
# file_data = open('inputdata_b10', 'r')  # 500250
# file_error = open('inputerror_b10', 'r')  # 500250
# file_flipped = open('flipped_b10', 'r')  # 10005
# file_affected = open('affected_b10', 'r')  # 500250
# file_weights = h5py.File('weights_b10.hdf5', 'r')
file_h_states_J = h5py.File('hidden_states_J_f.hdf5', 'r')
# file_h_states_J_free = h5py.File('hidden_states_J_e_free.hdf5', 'r')
...
'''
print file_h_states_J_free.keys() # input, affected, hidden_states
